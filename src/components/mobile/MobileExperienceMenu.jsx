      ...
      >
        ...
        {enablePreferences && (
          <div className="space-y-3 pt-3 border-t border-primary/10">
            ...
            <button
              onClick={toggleTheme}
              className="w-full flex items-center justify-between px-4 py-3 rounded-2xl bg-white/70 dark:bg-white/5 border border-primary/10 hover:border-primary/40 transition-colors"
            >
            ...
            <div className="relative">
              ...
              {languageDropdownOpen && (
                <div className="mt-2 bg-white dark:bg-ink rounded-2xl border border-primary/10 overflow-hidden">
                  {['en', 'es'].map((lng) => (
                    <button
                      key={lng}
